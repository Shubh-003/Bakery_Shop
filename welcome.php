...
<form method="post">
	<table>
		<Tr>
			...
			<td>
				<input style="background-color: Transparent;border: none;" type="submit" name="btnsearchbycategory" value="Search">
			</td>
		</Tr>
	</table>
</form>
...
<form method="post">
	<table>
		<Tr>
			...
			<td>
				<input style="background-color: Transparent;border: none;" type="submit" name="btnsearch" value="Search">
			</td>
		</Tr>
	</table>
</form>
